...
def upgrade() -> None:
    ...
    with op.batch_alter_table('entity', schema=None) as batch_op:
        ...
        batch_op.drop_index('uix_entity_permalink', sqlite_where=sa.text("content_type = 'text/markdown' AND permalink IS NOT NULL"))
        ...
        batch_op.create_index('uix_entity_permalink_project', ['permalink', 'project_id'], unique=True, sqlite_where=sa.text("content_type = 'text/markdown' AND permalink IS NOT NULL"))
...
def downgrade() -> None:
    ...
    with op.batch_alter_table('entity', schema=None) as batch_op:
        ...
        batch_op.drop_index('uix_entity_permalink_project', sqlite_where=sa.text("content_type = 'text/markdown' AND permalink IS NOT NULL"))
        ...
        batch_op.create_index('uix_entity_permalink', ['permalink'], unique=1, sqlite_where=sa.text("content_type = 'text/markdown' AND permalink IS NOT NULL"))
